...
import practice3.core.KnowledgeGraph;
import practice3.core.Relationship;
import practice3.editor.Editor;
import practice3.editor.EntityEditor;
import practice3.editor.RelationshipEditor;
    ...
    public EntityLabel(Entity entity){
      ...
      this.setOnMouseClicked(event -> {
        if (event.getClickCount() == 2) {
          Editor<Entity> ed = new EntityEditor(); // 创建实体编辑框
          ed.setTarget(entity); // 设置编辑目标
...
//          ed.setTarget(relation); // 设置目标关系对象
